...
```bash
npx cogn@2.2.14 registry verify --remote --index https://github.com/<org>/<repo>/releases/latest/download/cognitive-registry.v2.json
```

为了可复现，建议固定 tag：

```bash
npx cogn@2.2.14 registry verify --remote --index https://github.com/<org>/<repo>/releases/download/vX.Y.Z/cognitive-registry.v2.json
```
