...
npx cogn@2.2.15 run code-reviewer --args "your code" --provider openai --model gpt-4o
```
...
npx cogn@2.2.15 run code-reviewer --args "your code" --provider anthropic --model claude-sonnet-4.5
```
...
npx cogn@2.2.15 run code-reviewer --args "your code" --provider ollama --model llama3.1
```
