...
<Tabs>
<TabItem value="v2" label="v2.2 格式（推荐）" default>

v2.2 格式将机器可读的元数据和人类可读的提示词分离：
...
<TabItem value="v1" label="v1 格式（简化版）">
...
:::tip 推荐
新项目请使用 v2.2 格式，它更适合工具链集成和自动化测试。
:::
...
- [模块格式](../guide/module-format) - 深入了解 v2.2 格式
- [参数传递](../guide/arguments) - 学习输入处理
- [模块库](../modules/) - 查看 code-simplifier 示例
