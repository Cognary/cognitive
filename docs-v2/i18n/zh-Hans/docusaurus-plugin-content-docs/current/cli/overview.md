...
Cognitive Modules CLI 通过 npm 分发。推荐入口是 `npx cogn@2.2.15 ...`（避免 PATH/二进制冲突导致误用）。
...
npx cogn@2.2.15 compose code-review-pipeline --args "code" --trace
```
...
# 更严格
npx cogn@2.2.15 run code-reviewer --args "..." --profile strict
