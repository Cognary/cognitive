...
```bash
# 简化代码
npx cogn@2.2.15 run code-simplifier --args "x = 1 + 2 + 3"

# 指定语言
echo '{"code": "const x = a && a.b && a.b.c", "language": "javascript"}' | npx cogn@2.2.15 run code-simplifier

# 美化输出
npx cogn@2.2.15 run code-simplifier --args "for i in range(len(arr)): print(arr[i])" --pretty
```
