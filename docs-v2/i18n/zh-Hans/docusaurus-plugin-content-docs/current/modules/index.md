...
| 模块 | 功能 | 格式 | 分类 |
|------|------|:----:|------|
| [code-reviewer](./code-reviewer) | 代码审查 | v1 | 代码质量 |
| [code-simplifier](./code-simplifier) | 代码简化（行为等价） | **v2** | 代码质量 |
| [task-prioritizer](./task-prioritizer) | 任务优先级排序 | v1 | 项目管理 |
| [api-designer](./api-designer) | REST API 设计 | v1 | 设计规范 |
| [ui-spec-generator](./ui-spec-generator) | UI 规范生成 | v1 | 设计规范 |
