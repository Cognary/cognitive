...
```json title="tests/empty-input.input.json"
{
  "code": "",
  "language": "python"
}
...
```json title="tests/empty-input.expected.json"
{
  "_validate": {
    "required": ["error"],
...
```json title="tests/must-preserve-behavior.input.json"
{
...
```json title="tests/must-preserve-behavior.expected.json"
{
  "_validate": {
...
```json title="tests/risky-change.expected.json"
{
  "_validate": {
    "required": ["changes"],
...
```yaml title=".github/workflows/test-modules.yml"
