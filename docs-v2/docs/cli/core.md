...
```bash
npx cogn@2.2.15 core new            # creates ./demo.md
npx cogn@2.2.15 core new my.md
```
...
npx cogn@2.2.15 core promote demo.md ./cognitive/modules/demo
```
...
```bash
npx cogn@2.2.15 core promote demo.md ./cognitive/modules/demo --force
```
