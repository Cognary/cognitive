...
- `npx cogn@2.2.16 migrate ...`

## Syntax

```bash
npx cogn@2.2.16 migrate <module> [--dry-run] [--no-backup]
npx cogn@2.2.16 migrate --all [--dry-run] [--no-backup]
```
...
# Migrate all
npx cogn@2.2.16 migrate --all --dry-run
```
...
npx cogn@2.2.16 run code-reviewer --args "test code" --pretty
```
