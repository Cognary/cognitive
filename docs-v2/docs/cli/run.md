...
If you want an even smaller path (no file), see [`core`](./core) and `npx cogn@2.2.15 core run --stdin`.
...
```bash
npx cogn@2.2.15 run code-reviewer --args "code" --provider openai --model gpt-4o
```
