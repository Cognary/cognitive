...
| 方式 | 适用场景 | 说明 |
|------|----------|------|
| **MCP Server** | Claude Desktop、Cursor 等 AI 工具 | `npx cogn@2.2.13 mcp` |
| **HTTP API** | n8n、Coze、Dify 等工作流平台 | `npx cogn@2.2.13 serve` |
| **CLI** | 命令行/脚本 | `npx cogn@2.2.13 run` |

> 本仓库的文档统一以 `npx cogn@2.2.13 ...` 作为权威入口，以避免本机 PATH 上存在其他同名命令导致的错觉。
